...
struct AutoCameraInitializationCandidate {
  ...
  double robust_observation_rmse = std::numeric_limits<double>::infinity();
  double median_observation_rmse = std::numeric_limits<double>::infinity();
  double p95_observation_rmse = std::numeric_limits<double>::infinity();
  ...
  int projection_failure_count = 0;
...
struct AutoCameraInitializationRefinedBasinCandidate {
  ...
  double full_outer_robust_rmse = std::numeric_limits<double>::infinity();
  double full_outer_median_rmse = std::numeric_limits<double>::infinity();
  double full_outer_p95_rmse = std::numeric_limits<double>::infinity();
  int full_outer_pose_success_count = 0;
  int full_outer_pose_failure_count = 0;
  double full_outer_max_rmse = std::numeric_limits<double>::infinity();
  int full_outer_worst_frame_index = -1;
  int full_outer_worst_board_id = -1;
