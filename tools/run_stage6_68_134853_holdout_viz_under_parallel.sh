...
OUTPUT_DIR="result_stereo/stage6_68_holdout_134853_viz_20260608_144419_to_134853_under_target_rescue_parallel"
...
{
  echo "[stage6-6.8-holdout-134853-viz-under-parallel] start: $(date)"
  echo "[stage6-6.8-holdout-134853-viz-under-parallel] pid: $$"
  ...
  echo "[stage6-6.8-holdout-134853-viz-under-parallel] end: $(date)"
  echo "[stage6-6.8-holdout-134853-viz-under-parallel] exit_code: ${exit_code}"
  exit "${exit_code}"
} >> "${LOG_FILE}" 2>&1
